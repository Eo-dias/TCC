...
<div class="hero-wing">
    ...
    <svg class="wing-svg" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path class="wing-line" d="M200,200 C220,150 260,110 300,100 C330,95 350,110 355,140 C360,170 340,200 300,225 C270,245 230,255 200,260" />
        <path class="wing-line" d="M200,200 C180,230 150,270 110,300 C80,320 50,330 40,310 C30,290 40,260 70,240 C100,220 150,205 200,200" />
    </svg>
</div>
    </div>
</section>
