...
<div class="hero-wing">
    ...
    <svg class="wing-svg" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path class="feather" d="M200,210 C210,170 260,100 320,80 C350,70 370,90 375,120 C380,150 365,180 340,200 C310,220 280,240 240,260 C220,270 210,280 200,290 Z" />
        <path class="feather" d="M200,210 C215,180 270,120 330,100 C355,90 370,110 372,140 C374,170 360,200 335,220 C305,240 275,255 240,265 Z" />
        <path class="feather" d="M200,220 C210,200 250,155 300,130 C330,115 350,125 355,150 C360,175 345,200 320,215 C295,230 260,245 230,255 Z" />
        <path class="feather" d="M200,230 C205,215 235,180 275,160 C300,148 320,155 325,175 C330,195 315,215 290,228 C265,240 235,250 215,258 Z" />
        <path class="feather" d="M200,240 C200,230 220,205 250,190 C270,180 285,188 288,205 C290,220 278,235 260,245 C242,255 220,260 208,263 Z" />
        <path class="feather" d="M200,250 C195,245 210,230 235,222 C250,216 262,220 264,232 C266,242 258,250 245,256 C232,262 215,264 205,264 Z" />
        <path class="feather-lower" d="M200,210 C190,170 140,100 80,80 C50,70 30,90 25,120 C20,150 35,180 60,200 C90,220 120,240 160,260 C180,270 190,280 200,290 Z" />
        <path class="feather-lower" d="M200,220 C195,190 155,130 105,110 C80,100 65,115 62,140 C60,165 72,190 95,210 C118,230 148,248 178,258 Z" />
        <path class="feather-lower" d="M200,235 C198,215 168,168 130,145 C110,135 98,145 96,162 C94,180 105,198 125,212 C145,225 170,240 192,250 Z" />
    </svg>
</div>
    </div>
</section>
