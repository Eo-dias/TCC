...
<div class="hero-wing">
    ...
    <svg class="wing-svg" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path class="wing-shape" d="M170,260 C180,240 220,180 280,140 C320,115 360,110 385,130 C395,140 400,160 395,180 C390,200 365,220 330,240 C295,260 255,275 220,285 C200,290 185,285 175,275 Z" />
        <path class="wing-spine" d="M175,270 C190,235 240,170 300,135 C340,115 370,115 390,135" />
        <path class="wing-barb" d="M195,250 C200,230 220,190 250,165 C230,175 210,200 195,230" />
        <path class="wing-barb" d="M215,225 C225,200 255,160 290,140 C270,155 245,185 220,210" />
        <path class="wing-barb" d="M235,200 C250,175 280,145 315,130 C295,148 265,180 240,205" />
        <path class="wing-barb" d="M255,180 C270,160 295,140 330,130 C310,145 285,170 260,190" />
        <path class="wing-barb" d="M275,165 C290,150 315,135 345,130 C325,142 300,160 280,175" />
        <path class="wing-barb" d="M295,155 C310,142 335,130 360,130 C340,140 315,155 290,170" />
        <path class="wing-barbule" d="M200,245 C210,235 220,225 225,215" />
        <path class="wing-barbule" d="M225,218 C240,200 265,170 290,150" />
        <path class="wing-barbule" d="M250,190 C265,172 290,150 315,138" />
        <path class="wing-barbule" d="M270,175 C285,160 305,145 330,135" />
    </svg>
</div>
    </div>
</section>
